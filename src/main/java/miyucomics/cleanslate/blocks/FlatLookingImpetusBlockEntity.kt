...
class FlatLookingImpetusBlockEntity(position: BlockPos, state: BlockState) : BlockEntityAbstractImpetus(CleanslateBlocks.FLAT_LOOKING_IMPETUS_BLOCK_ENTITY, position, state) {
