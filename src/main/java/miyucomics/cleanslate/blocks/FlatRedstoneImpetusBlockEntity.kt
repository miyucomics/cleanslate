...
class FlatRedstoneImpetusBlockEntity(position: BlockPos, state: BlockState) : BlockEntityAbstractImpetus(CleanslateBlocks.FLAT_REDSTONE_IMPETUS_BLOCK_ENTITY, position, state) {
