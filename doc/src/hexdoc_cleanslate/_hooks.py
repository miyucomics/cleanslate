...
import hexdoc_cleanslate

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class CleanslatePlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return CleanslateModPlugin(branch=branch)


class CleanslateModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "cleanslate"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_cleanslate, "_templates"
